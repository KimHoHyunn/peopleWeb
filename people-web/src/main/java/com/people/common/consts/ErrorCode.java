...
public enum ErrorCode {
	...
	, NOT_IMPLEMENTE(501, "999501", "INTERNAL SERVER ERROR")
    , BAD_GATEWAY(502, "999502", "INTERNAL SERVER ERROR")
    , SERVICE_UNAVAILABLE(503, "999503", "INTERNAL SERVER ERROR")
    , GATEWAY_TIMEOUT(504, "999504", "INTERNAL SERVER ERROR")
    , HTTP_VERSION_NOT_SUPPORTED(505, "999505", "INTERNAL SERVER ERROR")
    , VARIANT_ALSO_NEGOTIATES(506, "999506", "INTERNAL SERVER ERROR")
    , INSUFFICEIENT_STORAGE(507, "999507", "INTERNAL SERVER ERROR")
    , LOOP_DETECTED(508, "999508", "INTERNAL SERVER ERROR")
    , NOT_EXTENDED(510, "999510", "INTERNAL SERVER ERROR")
    , NETWORK_AUTHENTICATION_REQUIRED(511, "999511", "INTERNAL SERVER ERROR")
    ;
